function NeuralNetwork(input_neurons, hidden_neurons, output_config) {
    ...
    for (i = 0; i < output_config.length + hidden_neurons; i++) {
    ...
    for (i = 0; i < hidden_neurons; i++) {
        ...
        this.props.real_output_config[i] = 'relu';
    }
    ...
    this.calc = function(inputs) {
        ...
        real_outputs = Helper.activateVector(real_outputs, this.props.real_output_config);
